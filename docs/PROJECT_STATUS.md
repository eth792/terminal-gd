...
| **v0.1.6** | **2025-11-13** | **31.9% (预期)** | **Rule 3.5调整+提取逻辑诊断** | **[实测报告](../analysis/v0.1.6/v0.1.6_实测报告.md)** |
...
- Review: 25 → **24** (-1, -4.0%)
- **自动通过率**: 31.5% → **31.9%** (+0.4%)
- **关键发现**: 提取逻辑错误影响 11-16 个案例（预期修复后 +5-7% 自动通过率）

---

### 🔥 进行中

#### Phase 4: 提取逻辑修复 (v0.1.7-v0.1.8) - **下一阶段** 🔥
