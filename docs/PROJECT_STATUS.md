...
**最后更新**: 2025-11-18
**当前版本**: v0.1.8 (Supplier-Threshold Code Salvage)
...
|------|------|-------------|---------------|
| **自动通过率** | **32%** | +789% (8.89x) | 40-45% |
| Exact | 71 / 222 | +63 (+789%) | 80-90 |
| Review | 17 / 222 | -55 (-68.8%) | 30-40 |
| Fail | 134 / 222 | -8 (-6.0%) | 90-100 |
...
| ❌ v0.1.7 | 2025-11-14 | 0.0% | ❌ 提取逻辑修复失败（已回滚） | [失败分析](../analysis/v0.1.7/v0.1.7_failure_analysis.md) || **v0.1.7a** | **2025-11-18** | **14%** | **CLI configuration priority fix** | **[实测报告](../analysis/v0.1.7a/v0.1.7a_实测报告.md)** |
| **v0.1.8** | **2025-11-18** | **32%** | **Supplier-Threshold Code Salvage** | **[实测报告](../analysis/v0.1.8/v0.1.8_实测报告.md)** |
