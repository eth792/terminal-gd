...
**最后更新**: 2025-11-13 15:45
**当前版本**: v0.1.5 (P1优化)
**下一版本**: v0.1.6 (P2优化 + 关键修复) - 🔥 进行中
...
#### Phase 3: P2优化 + 关键修复 (v0.1.6) - **当前阶段** 🔥

**关键修复（P0/P1）**:
- [ ] **修复匹配失误案例**（baohuixianlanjituan4100965990.txt）
- [ ] **OCR 归一化补充**（"工理"→"工程"）
- [ ] **目录命名优化**（去掉秒级时间戳）

**P2优化（原计划）**:
- [ ] 调整 Rule 3.5 约束（放宽阈值 f2_score 至 0.75，f1_score 上界至 0.65）
- [ ] 分析 FIELD_SIM_LOW_PROJECT 增加原因（+13 个案例）
...
- 匹配修复救回 1-3 个案例
- OCR 归一化救回 1-3 个案例
- Rule 3.5 调整救回 8-13 个案例
- **合计**: +17-24 个案例（保守目标 34%，乐观目标 36%）
